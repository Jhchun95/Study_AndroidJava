...
public class GridExampleFragment extends VerticalGridFragment implements OnItemViewSelectedListener, OnItemViewClickedListener {
    ...
    private void createRows() {
        ...
        // java - androidx.leanback.leanbackshowcase - models - CardRow Java Class
        CardRow row = new Gson().fromJson(json, CardRow.class);

        mAdapter.addAll(0, row.getCards());
    }

    // If you click items, you can see Full Image Screen.
    ...
    public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row) {
        ...
        Card card = (Card) item;
        URI id = card.getImageURI();
        String title = card.getTitle();

        // java - androidx.leanback.leanbackshowcase - app - grid - ImageFull Java Class
        Intent intent = new Intent(getContext(), ImageFull.class);

        Bundle bundle = new Bundle();
        bundle.putString("title", title);
        bundle.putString("uri", id.toString());
