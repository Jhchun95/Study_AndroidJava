 ...
 */
        ...
        import com.example.anyangstagram.common.TitleBackgroundButton;
        import com.example.anyangstagram.common.TitleBitmapButton;
        import com.example.anyangstagram.db.MemoDatabase;
...
public class MemoInsertActivity extends Activity {
    ...
    public void setMediaImage(String photoId, String photoUri, String videoId, String voiceId, String handwritingId) {
        ...
        if(photoId.equals("") || photoId.equals("-1")) {
            mPhoto.setImageResource(R.drawable.person_add2);
        } else {
