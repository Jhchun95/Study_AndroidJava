...
public class SearchListViewAdapter extends BaseAdapter {
    ...
    private List<SearchWorldPopulation> worldpopulationlist = null;
    private ArrayList<SearchWorldPopulation> arraylist;

    public SearchListViewAdapter(Context context, List<SearchWorldPopulation> worldpopulationlist) {
        mContext = context;
        this.worldpopulationlist = worldpopulationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<SearchWorldPopulation>();
    ...
    @Override
    public SearchWorldPopulation getItem(int position) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, SearchSingleItemView.class);
                // Pass all data sort
    ...
    public void filter(String charText) {
        ...
        {
            for (SearchWorldPopulation wp : arraylist)
            {
